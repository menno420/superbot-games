...
⚑ needs-owner: ORDER 004 (owner-requested lane self-review) remains OPEN for a future wake — not consumed this docs-only session. Plus the OWNER-ACTION block below + docs/retro/archive-ready-2026-07-11.md.
...
- WHAT: ORDER 004 — owner-requested lane self-review (~24h) is still OPEN; a future wake owes the dated "Self-review" section here. WHERE: control/status.md. HOW: a future session consumes it. WHY-IT-MATTERS: fleet-wide sweep collects it. VERIFIED-NEEDED: none.
