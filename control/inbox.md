...
## ORDER 011 · 2026-07-19T07:17:50Z · status: new
priority: routine
...
## ORDER 012 · 2026-07-20T13:22:06Z · status: new
priority: P1
do: Your substrate-kit v1.20.1 upgrade PR #183 is red on its substrate-gate: the new gate flags pre-existing false-wall findings in this repo's docs (see the PR body's finding list). Fix on the PR branch with plain additive commits: rephrase each flagged standing-limitation line as a dated past-tense fact or add a dated supersession note (never delete history; owner-verbatim lines go in the checker's allowlist if supported). Reference implementation: fleet-manager PR #390 (commit d0e16e2). Gate green means the armed auto-merge lands the upgrade.
...
done-when: PR #183's substrate-gate is green and the armed auto-merge has landed the v1.20.1 upgrade on main.
